...
export function createReferenceNode(name: string, inArray: boolean = false): SchemaObjectNode {
...
export function extractSchema(schemaDef: SchemaDef, theme: ThemeContextValue): SchemaType[] {
  ...
  function createArray(arraySchemaType: ArraySchemaType): SchemaArrayNode | SchemaNullNode {
