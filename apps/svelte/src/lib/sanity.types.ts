...
export type ShoesListQueryResult = Array<{
  title: string | null;
  slug: Slug | null;
  price: string | null;
  media: {
...
// Source: src/lib/queries.ts
// Variable: shoeQuery
// Query: *[_type == "shoe" && slug.current == $slug]{  _id,  title,  slug,  "price": string(price),  "media": media[]{ alt, asset, crop, hotspot, _key },  "brand": brandReference->{name, slug, logo{ alt, asset, crop, hotspot }},  description,}[0]
export type ShoeQueryResult = {
  _id: string;
  title: string | null;
  slug: Slug | null;
  price: string | null;
